...
| `metadata` | `str` | Query, Optional | Filter refunds by metadata content. |

## Response Type

**200**: List of refunds retrieved successfully.

This method returns an [`ApiResponse`](../../doc/api-response.md) instance. The `body` property of this instance returns the response data which is of type [`RefundList`](../../doc/models/refund-list.md).
