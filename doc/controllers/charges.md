...
This method returns an [`ApiResponse`](../../doc/api-response.md) instance. The `body` property of this instance returns the response data which is of type [`Charge`](../../doc/models/charge.md).
...
body = ChargeCreateRequest(
    ...
    redirect=ChargeCreateRequestRedirect(
...
| `last_four` | `str` | Query, Optional | Filter by the last 4 digits of the card.  **Note:** If specified, `name`, `exp_month`, and `exp_year` must also be included. |
| `name` | `str` | Query, Optional | Filter by cardholder name.  **Note:** If specified, `last_four`, `exp_month`, and `exp_year` must also be included. |
| `exp_month` | `int` | Query, Optional | Filter by expiration month.  **Note:** If specified, `last_four`, `name`, and `exp_year` must also be included. |
| `exp_year` | `int` | Query, Optional | Filter by expiration year.  **Note:** If specified, `last_four`, `name`, and `exp_month` must also be included. |
| `mfrom` | `str` | Query, Optional | Show charges created on or after this date (ISO-8601). |
| `to` | `str` | Query, Optional | Show charges created before this date (ISO-8601). |
| `email` | `str` | Query, Optional | Filter by email address. |
| `phone` | `str` | Query, Optional | Filter by phone number. |
| `amount_from` | `int` | Query, Optional | Show charges with an amount greater than or equal to this value. |
| `amount_to` | `int` | Query, Optional | Show charges with an amount strictly less than this value. |
...
| `transaction_token_id` | `uuid\|str` | Query, Optional | Filter by transaction token ID. |

## Response Type

**200**: List of Charges

This method returns an [`ApiResponse`](../../doc/api-response.md) instance. The `body` property of this instance returns the response data which is of type [`ChargeList`](../../doc/models/charge-list.md).
...
This method returns an [`ApiResponse`](../../doc/api-response.md) instance. The `body` property of this instance returns the response data which is of type [`IssuerToken`](../../doc/models/issuer-token.md).
...
This method returns an [`ApiResponse`](../../doc/api-response.md) instance. The `body` property of this instance returns the response data which is of type [`ThreeDsIssuerToken`](../../doc/models/three-ds-issuer-token.md).
...
This method returns an [`ApiResponse`](../../doc/api-response.md) instance. The `body` property of this instance returns the response data which is of type [`BankTransferLedgerList`](../../doc/models/bank-transfer-ledger-list.md).
...
|  --- | --- | --- | --- |
| `store_id` | `uuid\|str` | Template, Required | The unique identifier of the store. |
| `charge_id` | `uuid\|str` | Template, Required | The unique identifier of the charge. |
...
This method returns an [`ApiResponse`](../../doc/api-response.md) instance. The `body` property of this instance returns the response data which is of type [`CustomsDeclarationWebhookData`](../../doc/models/customs-declaration-webhook-data.md).
...
body = CustomsDeclarationCreateRequest(
    customs='TOKYO',
...
| `store_id` | `uuid\|str` | Template, Required | The unique identifier of the store. |
| `charge_id` | `uuid\|str` | Template, Required | The unique identifier of the charge. |
| `id` | `uuid\|str` | Template, Required | The unique identifier of the customs declaration. |
...
body = CustomsDeclarationPatchRequest(
