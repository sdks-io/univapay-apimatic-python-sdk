...
This method returns an [`ApiResponse`](../../doc/api-response.md) instance. The `body` property of this instance returns the response data which is of type [`CheckoutInfo`](../../doc/models/checkout-info.md).

## Example Usage

```python
result = checkout_api.get_checkout_info()
