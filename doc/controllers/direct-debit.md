...
|  --- | --- | --- | --- |
| `merchant_id` | `uuid\|str` | Template, Required | The unique identifier of the merchant. |

## Response Type

**200**: Direct Debit Configuration

This method returns an [`ApiResponse`](../../doc/api-response.md) instance. The `body` property of this instance returns the response data which is of type [`DirectDebitMerchantConfiguration`](../../doc/models/direct-debit-merchant-configuration.md).
...
This method returns an [`ApiResponse`](../../doc/api-response.md) instance. The `body` property of this instance returns the response data which is of type [`DirectDebitNotificationConfiguration`](../../doc/models/direct-debit-notification-configuration.md).
...
This method returns an [`ApiResponse`](../../doc/api-response.md) instance. The `body` property of this instance returns the response data which is of type [`DirectDebitSchedule`](../../doc/models/direct-debit-schedule.md).
...
| `cursor` | `str` | Query, Optional | Cursor pointing to the resource after which pagination should continue.<br><br>**Constraints**: *Pattern*: `^[0-9]+$` |
| `cursor_direction` | [`CursorDirectionQuery`](../../doc/models/cursor-direction-query.md) | Query, Optional | Pagination direction relative to the supplied cursor.<br><br>**Default**: `"desc"` |
| `user_number` | `str` | Query, Optional | Filter by the merchant's own membership number for the consumer (会員番号).<br><br>**Constraints**: *Pattern*: `^[a-zA-Z0-9]+$` |
| `bank_account_id` | `str` | Query, Optional | Filter by a single bank account ID.<br><br>**Constraints**: *Pattern*: `^[0-9]+$` |
| `bank_code` | `str` | Query, Optional | Filter by the 4-digit bank code (銀行コード).<br><br>**Constraints**: *Minimum Length*: `4`, *Maximum Length*: `4`, *Pattern*: `^[0-9]{4}$` |
| `bank_name` | `str` | Query, Optional | Filter by bank name in half-width katakana (銀行名).<br><br>**Constraints**: *Maximum Length*: `15` |
| `branch_code` | `str` | Query, Optional | Filter by the 3-digit branch code (支店コード).<br><br>**Constraints**: *Minimum Length*: `3`, *Maximum Length*: `3`, *Pattern*: `^[0-9]{3}$` |
...
| `bank_account_number` | `str` | Query, Optional | Filter by the 7-digit account number (口座番号).<br><br>**Constraints**: *Minimum Length*: `7`, *Maximum Length*: `7`, *Pattern*: `^[0-9]{7}$` |
| `bank_account_name` | `str` | Query, Optional | Filter by account holder name in half-width katakana (口座名義).<br><br>**Constraints**: *Maximum Length*: `30`, *Pattern*: `^[A-Z0-9ｱ-ﾝﾞﾟ().\- ]{1,30}$` |
...
| `mfrom` | `str` | Query, Optional | Show bank accounts created on or after this date (ISO-8601). |
| `to` | `str` | Query, Optional | Show bank accounts created before this date (ISO-8601). |

## Response Type

**200**: List of Bank Accounts

This method returns an [`ApiResponse`](../../doc/api-response.md) instance. The `body` property of this instance returns the response data which is of type [`DirectDebitBankAccountList`](../../doc/models/direct-debit-bank-account-list.md).
...
This method returns an [`ApiResponse`](../../doc/api-response.md) instance. The `body` property of this instance returns the response data which is of type [`DirectDebitBankAccount`](../../doc/models/direct-debit-bank-account.md).
...
body = DirectDebitBankAccountCreateRequest(
    user_number='SD02688328',
    bank_code='0012',
    bank_name='ﾗｸﾃﾝｷﾞﾝｺｳ',
    branch_code='120',
...
|  --- | --- | --- | --- |
| `merchant_id` | `uuid\|str` | Template, Required | The unique identifier of the merchant. |
| `bank_account_id` | `str` | Template, Required | The unique identifier of the direct debit bank account.<br><br>**Constraints**: *Pattern*: `^[0-9]+$` |
...
body = DirectDebitBankAccountUpdateRequest(
    bank_account_name='ﾀﾅｶﾕﾐｺ'
)
...
This method returns an [`ApiResponse`](../../doc/api-response.md) instance. The `body` property of this instance returns the response data which is of type [`DirectDebitBankTransfer`](../../doc/models/direct-debit-bank-transfer.md).
...
body = DirectDebitBankTransferCreateRequest(
    amount=1000
)
...
| `cursor` | `str` | Query, Optional | Cursor pointing to the resource after which pagination should continue.<br><br>**Constraints**: *Pattern*: `^[0-9]+$` |
| `cursor_direction` | [`CursorDirectionQuery`](../../doc/models/cursor-direction-query.md) | Query, Optional | Pagination direction relative to the supplied cursor.<br><br>**Default**: `"desc"` |
| `bank_transfer_id` | `str` | Query, Optional | Filter by a single bank transfer ID.<br><br>**Constraints**: *Pattern*: `^[0-9]+$` |
| `bank_transfer_start` | `str` | Query, Optional | Start of the year-month range in which the transfer is scheduled to occur.<br><br>**Constraints**: *Pattern*: `^[0-9]{4}-[0-9]{2}$` |
| `bank_transfer_end` | `str` | Query, Optional | End of the year-month range in which the transfer is scheduled to occur.<br><br>**Constraints**: *Pattern*: `^[0-9]{4}-[0-9]{2}$` |
...
This method returns an [`ApiResponse`](../../doc/api-response.md) instance. The `body` property of this instance returns the response data which is of type [`DirectDebitBankTransferList`](../../doc/models/direct-debit-bank-transfer-list.md).
...
|  --- | --- | --- | --- |
| `merchant_id` | `uuid\|str` | Template, Required | The unique identifier of the merchant. |
| `bank_transfer_id` | `str` | Template, Required | The unique identifier of the direct debit bank transfer.<br><br>**Constraints**: *Pattern*: `^[0-9]+$` |
...
body = DirectDebitBankTransferPatchRequest(
    amount=1850
)
