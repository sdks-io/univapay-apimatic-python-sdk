...
# Token Cvv Auth Check Updated Webhook Callback
...
| `event` | `str` | Required, Constant | Event type discriminator — always `token_cvv_auth_check_updated` for this callback.<br><br>**Value**: `"token_cvv_auth_check_updated"` |
...
from univapayclientsdk.models.token_cvv_auth_check_updated_webhook_callback import TokenCvvAuthCheckUpdatedWebhookCallback
...
token_cvv_auth_check_updated_webhook_callback = TokenCvvAuthCheckUpdatedWebhookCallback(
