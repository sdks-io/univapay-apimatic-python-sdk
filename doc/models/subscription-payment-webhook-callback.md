...
# Subscription Payment Webhook Callback

Webhook envelope for the subscription_payment event.
...
| `event` | `str` | Required, Constant | Event type discriminator — always `subscription_payment` for this callback.<br><br>**Value**: `"subscription_payment"` |
...
from univapayclientsdk.models.subscription_payment_webhook_callback import SubscriptionPaymentWebhookCallback
...
subscription_payment_webhook_callback = SubscriptionPaymentWebhookCallback(
