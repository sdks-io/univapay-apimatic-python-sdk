...
# Subscription Canceled Webhook Callback

Webhook envelope for the subscription_canceled event.
...
| `event` | `str` | Required, Constant | Event type discriminator — always `subscription_canceled` for this callback.<br><br>**Value**: `"subscription_canceled"` |
...
from univapayclientsdk.models.subscription_canceled_webhook_callback import SubscriptionCanceledWebhookCallback
...
subscription_canceled_webhook_callback = SubscriptionCanceledWebhookCallback(
