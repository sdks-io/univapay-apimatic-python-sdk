...
# Token Updated Webhook Callback

Webhook envelope for the token_updated event.
...
| `event` | `str` | Required, Constant | Event type discriminator — always `token_updated` for this callback.<br><br>**Value**: `"token_updated"` |
...
from univapayclientsdk.models.token_updated_webhook_callback import TokenUpdatedWebhookCallback
...
token_updated_webhook_callback = TokenUpdatedWebhookCallback(
