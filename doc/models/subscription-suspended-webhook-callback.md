...
# Subscription Suspended Webhook Callback
...
| `event` | `str` | Required, Constant | Event type discriminator — always `subscription_suspended` for this callback.<br><br>**Value**: `"subscription_suspended"` |
...
from univapayclientsdk.models.subscription_suspended_webhook_callback import SubscriptionSuspendedWebhookCallback
from univapayclientsdk.models.subscription_termination_mode import SubscriptionTerminationMode

subscription_suspended_webhook_callback = SubscriptionSuspendedWebhookCallback(
