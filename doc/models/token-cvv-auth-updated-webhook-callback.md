...
# Token Cvv Auth Updated Webhook Callback
...
| `event` | `str` | Required, Constant | Event type discriminator — always `token_cvv_auth_updated` for this callback.<br><br>**Value**: `"token_cvv_auth_updated"` |
...
from univapayclientsdk.models.token_cvv_auth_updated_webhook_callback import TokenCvvAuthUpdatedWebhookCallback
...
token_cvv_auth_updated_webhook_callback = TokenCvvAuthUpdatedWebhookCallback(
