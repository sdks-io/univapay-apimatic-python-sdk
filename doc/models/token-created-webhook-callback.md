...
# Token Created Webhook Callback
...
| `event` | `str` | Required, Constant | Event type discriminator — always `token_created` for this callback.<br><br>**Value**: `"token_created"` |
...
from univapayclientsdk.models.token_created_webhook_callback import TokenCreatedWebhookCallback
...
token_created_webhook_callback = TokenCreatedWebhookCallback(
