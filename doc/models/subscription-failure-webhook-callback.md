...
# Subscription Failure Webhook Callback

Webhook envelope for the subscription_failure event.
...
| `event` | `str` | Required, Constant | Event type discriminator — always `subscription_failure` for this callback.<br><br>**Value**: `"subscription_failure"` |
...
from univapayclientsdk.models.subscription_failure_webhook_callback import SubscriptionFailureWebhookCallback
...
subscription_failure_webhook_callback = SubscriptionFailureWebhookCallback(
