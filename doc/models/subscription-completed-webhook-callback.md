...
# Subscription Completed Webhook Callback
...
| `event` | `str` | Required, Constant | Event type discriminator — always `subscription_completed` for this callback.<br><br>**Value**: `"subscription_completed"` |
...
from univapayclientsdk.models.subscription_completed_webhook_callback import SubscriptionCompletedWebhookCallback
...
subscription_completed_webhook_callback = SubscriptionCompletedWebhookCallback(
