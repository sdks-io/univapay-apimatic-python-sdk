...
# Charge Updated Webhook Callback

Webhook envelope for the charge_updated event.
...
| `event` | `str` | Required, Constant | Event type discriminator — always `charge_updated` for this callback.<br><br>**Value**: `"charge_updated"` |
...
from univapayclientsdk.models.charge_updated_webhook_callback import ChargeUpdatedWebhookCallback

charge_updated_webhook_callback = ChargeUpdatedWebhookCallback(
