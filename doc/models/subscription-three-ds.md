...
| `redirect_endpoint` | `str` | Optional | URL the customer is redirected to for 3-D Secure authentication. |
| `redirect_id` | `uuid\|str` | Optional | Identifier of the 3-D Secure redirect. |
...
subscription_three_ds = SubscriptionThreeDs()
```
