...
# Token Replaced Webhook Callback

Webhook envelope for the token_replaced event.
...
| `event` | `str` | Required, Constant | Event type discriminator — always `token_replaced` for this callback.<br><br>**Value**: `"token_replaced"` |
...
from univapayclientsdk.models.token_replaced_webhook_callback import TokenReplacedWebhookCallback
...
token_replaced_webhook_callback = TokenReplacedWebhookCallback(
