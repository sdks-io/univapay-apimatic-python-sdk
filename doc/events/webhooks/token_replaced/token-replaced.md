...
This event's request payload is of type [TokenReplacedWebhookCallback](../../../../doc/models/token-replaced-webhook-callback.md).
...
def Webhooks() -> Response:
    ...
    # Step 3: Pattern match for tokenReplaced only.
    if (
