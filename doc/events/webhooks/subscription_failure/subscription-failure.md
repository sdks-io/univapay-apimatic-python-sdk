...
This event's request payload is of type [SubscriptionFailureWebhookCallback](../../../../doc/models/subscription-failure-webhook-callback.md).
...
def Webhooks() -> Response:
    ...
    # Step 3: Pattern match for subscriptionFailure only.
    if (
