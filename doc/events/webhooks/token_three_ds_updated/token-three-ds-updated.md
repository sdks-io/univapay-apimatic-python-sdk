...
This event's request payload is of type [TokenThreeDsUpdatedWebhookCallback](../../../../doc/models/token-three-ds-updated-webhook-callback.md).
...
def Webhooks() -> Response:
    ...
    # Step 3: Pattern match for tokenThreeDsUpdated only.
    if (
