...
This event's request payload is of type [TokenCvvAuthUpdatedWebhookCallback](../../../../doc/models/token-cvv-auth-updated-webhook-callback.md).
...
def Webhooks() -> Response:
    ...
    # Step 3: Pattern match for tokenCvvAuthUpdated only.
    if (
