...
Fired when a scheduled subscription payment is successfully processed. The `data` field contains the full Subscription object.
...
This event's request payload is of type [SubscriptionPaymentWebhookCallback](../../../../doc/models/subscription-payment-webhook-callback.md).
...
def Webhooks() -> Response:
    ...
    # Step 3: Pattern match for subscriptionPayment only.
    if (
