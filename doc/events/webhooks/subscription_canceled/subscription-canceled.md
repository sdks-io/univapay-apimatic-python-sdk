...
This event's request payload is of type [SubscriptionCanceledWebhookCallback](../../../../doc/models/subscription-canceled-webhook-callback.md).
...
def Webhooks() -> Response:
    ...
    # Step 3: Pattern match for subscriptionCanceled only.
    if (
