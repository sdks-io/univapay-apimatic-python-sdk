...
TokenEventType = Union[TokenWebhookEvent, UnknownEvent]
...
class TokenHandler:
    ...
    @staticmethod
    def parse_event(request: Request) -> TokenEventType:
        """
         Parse the event.

        :return: TokenWebhookEvent for successful parsing; UnknownEvent for unknown
                 events.
        :rtype: Union[TokenWebhookEvent, UnknownEvent]
        """
        # Deserialize payload
        try:
