...
CancelEventType = Union[CancelWebhookCallback, UnknownEvent]
...
class CancelHandler:
    ...
    @staticmethod
    def parse_event(request: Request) -> CancelEventType:
        """
         Parse the event.

        :return: CancelWebhookCallback for successful parsing; UnknownEvent for unknown
                 events.
        :rtype: Union[CancelWebhookCallback, UnknownEvent]
        """
        # Deserialize payload
        try:
