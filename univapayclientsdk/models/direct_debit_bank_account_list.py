...
class DirectDebitBankAccountList(object):
    """Implementation of the 'DirectDebitBankAccountList' model.

    Paginated list of direct debit bank accounts.

    Attributes:
        items (List[DirectDebitBankAccount]): List of resources.
    ...
    def __init__(
        ...
        """Initialize a DirectDebitBankAccountList instance."""
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get("items") is not None:
            items = [
                DirectDebitBankAccount.from_dictionary(x)
