...
class SubscriptionSuspendedWebhookCallback(object):
    """Implementation of the 'SubscriptionSuspendedWebhookCallback' model.

    Webhook envelope for the subscription_suspended event.

    Attributes:
        id (uuid|str): Unique ID of this webhook delivery.
        event (str): Event type discriminator — always `subscription_suspended` for
            this callback.
    ...
    def __init__(
        ...
        """Initialize a SubscriptionSuspendedWebhookCallback instance."""
        # Initialize members of the class
        self.id = id
        self.event = "subscription_suspended"
