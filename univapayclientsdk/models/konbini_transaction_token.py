...
class KonbiniTransactionToken(object):
    """Implementation of the 'KonbiniTransactionToken' model.
    ...
    Attributes:
        ...
        payment_type (str): Payment method type. Always `konbini` for this variant.
        data (TokenResponseKonbiniData): Token Response Konbini Data schema.
    ...
    def __init__(
        ...
        """Initialize a KonbiniTransactionToken instance."""
    ...
    def from_dictionary(cls,
        ...
        data =\
            TokenResponseKonbiniData.from_dictionary(
                dictionary.get("data"))\
        ...
        if isinstance(dictionary, cls):
            return APIHelper.is_valid_type(
                ...
                and APIHelper.is_valid_type(
                    ...
                    type_callable=lambda value:
                        TokenResponseKonbiniData.validate(value),
                    is_model_dict=True)
