...
from univapayclientsdk.models.webhook_event import (
    WebhookEvent,
)


class WebhookEventList(object):
    """Implementation of the 'WebhookEventList' model.

    Paginated list of webhook events.

    Attributes:
        items (List[WebhookEvent]): List of resources.
    ...
    def __init__(
        ...
        """Initialize a WebhookEventList instance."""
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get("items") is not None:
            items = [
                WebhookEvent.from_dictionary(x)
