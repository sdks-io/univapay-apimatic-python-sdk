...
class SubscriptionUpdateScheduleSettings(object):
    ...
    Attributes:
        termination_mode (SubscriptionTerminationMode): Subscription Termination Mode
            schema.
        start_on (datetime): Subscription start date. Used to change the first actual
    ...
    def __init__(
        ...
        if start_on is not APIHelper.SKIP:
            self.start_on =\
                ...
                start_on, APIHelper.RFC3339DateTime)\
                 if start_on else None
    ...
    def from_dictionary(cls,
        ...
        start_on = APIHelper.RFC3339DateTime.from_value(
            dictionary.get("start_on")).datetime\
