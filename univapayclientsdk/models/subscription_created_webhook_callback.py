...
class SubscriptionCreatedWebhookCallback(object):
    """Implementation of the 'SubscriptionCreatedWebhookCallback' model.

    Webhook envelope for the subscription_created event.

    Attributes:
        id (uuid|str): Unique ID of this webhook delivery.
        event (str): Event type discriminator — always `subscription_created` for
            this callback.
    ...
    def __init__(
        ...
        """Initialize a SubscriptionCreatedWebhookCallback instance."""
        # Initialize members of the class
        self.id = id
        self.event = "subscription_created"
