...
class CardProcessorInstallmentConfig(object):
    """Implementation of the 'CardProcessorInstallmentConfig' model.

    Card-processor capabilities available for installment payments.

    Attributes:
        revolving (bool): Allows revolving payments through supported processors.
        fixed_cycle (bool): Allows fixed-cycle installment payments through supported
            processors.
    ...
    def __init__(
        ...
        """Initialize a CardProcessorInstallmentConfig instance."""
