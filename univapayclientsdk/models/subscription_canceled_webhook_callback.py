...
class SubscriptionCanceledWebhookCallback(object):
    """Implementation of the 'SubscriptionCanceledWebhookCallback' model.

    Webhook envelope for the subscription_canceled event.

    Attributes:
        id (uuid|str): Unique ID of this webhook delivery.
        event (str): Event type discriminator — always `subscription_canceled` for
            this callback.
    ...
    def __init__(
        ...
        """Initialize a SubscriptionCanceledWebhookCallback instance."""
        # Initialize members of the class
        self.id = id
        self.event = "subscription_canceled"
