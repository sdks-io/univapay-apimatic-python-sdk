...
class DirectDebitBankAccountUpdateRequest(object):
    """Implementation of the 'DirectDebitBankAccountUpdateRequest' model.

    Request payload for updating a registered bank account. Omitted fields are left
    unchanged.
    ...
    def __init__(
        ...
        """Initialize a DirectDebitBankAccountUpdateRequest instance."""
