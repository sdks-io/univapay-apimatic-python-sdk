...
class DirectDebitBankTransferList(object):
    """Implementation of the 'DirectDebitBankTransferList' model.

    Paginated list of direct debit bank transfers.

    Attributes:
        items (List[DirectDebitBankTransfer]): List of resources.
    ...
    def __init__(
        ...
        """Initialize a DirectDebitBankTransferList instance."""
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get("items") is not None:
            items = [
                DirectDebitBankTransfer.from_dictionary(x)
