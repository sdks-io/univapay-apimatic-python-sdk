...
class TokenResponsePhoneNumber(object):
    """Implementation of the 'TokenResponsePhoneNumber' model.

    Token Response Phone Number schema.

    Attributes:
        country_code (int): Returned as an integer in the response.
    ...
    def __init__(
        ...
        """Initialize a TokenResponsePhoneNumber instance."""
