...
class RecurringTokenDeletedWebhookCallback(object):
    """Implementation of the 'RecurringTokenDeletedWebhookCallback' model.

    Webhook envelope for the recurring_token_deleted event.

    Attributes:
        id (uuid|str): Unique ID of this webhook delivery.
        event (str): Event type discriminator — always `recurring_token_deleted` for
            this callback.
    ...
    def __init__(
        ...
        """Initialize a RecurringTokenDeletedWebhookCallback instance."""
        # Initialize members of the class
        self.id = id
        self.event = "recurring_token_deleted"
