...
class SubscriptionPaymentList(object):
    """Implementation of the 'SubscriptionPaymentList' model.

    Paginated list of subscription payments.

    Attributes:
        items (List[SubscriptionPayment]): List of resources.
    ...
    def __init__(
        ...
        """Initialize a SubscriptionPaymentList instance."""
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get("items") is not None:
            items = [
                SubscriptionPayment.from_dictionary(x)
