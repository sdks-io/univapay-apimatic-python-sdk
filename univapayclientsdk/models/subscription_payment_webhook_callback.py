...
class SubscriptionPaymentWebhookCallback(object):
    """Implementation of the 'SubscriptionPaymentWebhookCallback' model.

    Webhook envelope for the subscription_payment event.

    Attributes:
        id (uuid|str): Unique ID of this webhook delivery.
        event (str): Event type discriminator — always `subscription_payment` for
            this callback.
    ...
    def __init__(
        ...
        """Initialize a SubscriptionPaymentWebhookCallback instance."""
        # Initialize members of the class
        self.id = id
        self.event = "subscription_payment"
