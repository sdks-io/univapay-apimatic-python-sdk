...
from univapayclientsdk.models.token_response_paidy_data import (
    TokenResponsePaidyData,
)


class PaidyTransactionToken(object):
    """Implementation of the 'PaidyTransactionToken' model.
    ...
    Attributes:
        ...
        payment_type (str): Payment method type. Always `paidy` for this variant.
        data (TokenResponsePaidyData): Token Response Paidy Data schema.
    ...
    def __init__(
        ...
        """Initialize a PaidyTransactionToken instance."""
    ...
    def from_dictionary(cls,
        ...
        data =\
            TokenResponsePaidyData.from_dictionary(
                dictionary.get("data"))\
        ...
        if isinstance(dictionary, cls):
            return APIHelper.is_valid_type(
                ...
                and APIHelper.is_valid_type(
                    ...
                    type_callable=lambda value:
                        TokenResponsePaidyData.validate(value),
                    is_model_dict=True)
