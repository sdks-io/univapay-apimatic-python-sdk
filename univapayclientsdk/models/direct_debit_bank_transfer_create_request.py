...
class DirectDebitBankTransferCreateRequest(object):
    """Implementation of the 'DirectDebitBankTransferCreateRequest' model.
    ...
    def __init__(
        ...
        """Initialize a DirectDebitBankTransferCreateRequest instance."""
