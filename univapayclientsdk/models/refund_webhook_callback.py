...
class RefundWebhookCallback(object):
    """Implementation of the 'RefundWebhookCallback' model.

    Webhook envelope whose `data` payload is a Refund resource.

    Attributes:
        event (RefundEvent): Event type discriminator — always `refund_finished` for
            this callback.
    ...
    def __init__(
        ...
        """Initialize a RefundWebhookCallback instance."""
