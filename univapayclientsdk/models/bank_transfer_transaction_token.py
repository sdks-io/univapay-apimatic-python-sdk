...
class BankTransferTransactionToken(object):
    """Implementation of the 'BankTransferTransactionToken' model.
    ...
    Attributes:
        ...
        payment_type (str): Payment method type. Always `bank_transfer` for this
            variant.
        data (TokenResponseBankTransferData): Token Response Bank Transfer Data
            schema.
    ...
    def __init__(
        ...
        """Initialize a BankTransferTransactionToken instance."""
        ...
        self.payment_type = "bank_transfer"
        self.data = data
    ...
    def from_dictionary(cls,
        ...
        data =\
            TokenResponseBankTransferData.from_dictionary(
                dictionary.get("data"))\
        ...
        if isinstance(dictionary, cls):
            return APIHelper.is_valid_type(
                ...
                and APIHelper.is_valid_type(
                    ...
                    type_callable=lambda value:
                        TokenResponseBankTransferData.validate(value),
                    is_model_dict=True)
