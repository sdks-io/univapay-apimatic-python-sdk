...
class TransactionTokenBase(object):
    """Implementation of the 'TransactionTokenBase' model.
    ...
    layers those on top with `data` pinned to its own shape; see `TransactionToken`
    for the discriminated union that ties them together.
    ...
    def __init__(
        ...
        """Initialize a TransactionTokenBase instance."""
