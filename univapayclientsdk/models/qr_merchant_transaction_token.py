...
from univapayclientsdk.models.token_response_qr_merchant_data import (
    TokenResponseQrMerchantData,
)


class QrMerchantTransactionToken(object):
    """Implementation of the 'QrMerchantTransactionToken' model.

    Stored transaction token resource for a `qr_merchant` (QR Merchant-Presented
    Mode) payment type.
    ...
    Attributes:
        ...
        payment_type (str): Payment method type. Always `qr_merchant` for this
            variant.
        data (TokenResponseQrMerchantData): Token Response Qr Merchant Data schema.
    ...
    def __init__(
        ...
        """Initialize a QrMerchantTransactionToken instance."""
    ...
    def from_dictionary(cls,
        ...
        data =\
            TokenResponseQrMerchantData.from_dictionary(
                dictionary.get("data"))\
        ...
        if isinstance(dictionary, cls):
            return APIHelper.is_valid_type(
                ...
                and APIHelper.is_valid_type(
                    ...
                    type_callable=lambda value:
                        TokenResponseQrMerchantData.validate(value),
                    is_model_dict=True)
