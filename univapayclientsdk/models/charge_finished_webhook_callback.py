...
class ChargeFinishedWebhookCallback(object):
    """Implementation of the 'ChargeFinishedWebhookCallback' model.

    Webhook envelope for the charge_finished event.

    Attributes:
        id (uuid|str): Unique ID of this webhook delivery.
        event (str): Event type discriminator — always `charge_finished` for this
            callback.
    ...
    def __init__(
        ...
        """Initialize a ChargeFinishedWebhookCallback instance."""
        # Initialize members of the class
        self.id = id
        self.event = "charge_finished"
