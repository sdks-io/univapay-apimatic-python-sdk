...
class BankTransferStatusWebhookCallbackExtension(object):
    """Implementation of the 'BankTransferStatusWebhookCallbackExtension' model.
    ...
    def __init__(
        ...
        """Initialize a BankTransferStatusWebhookCallbackExtension instance."""
