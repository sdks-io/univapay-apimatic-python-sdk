...
class SubscriptionCompletedWebhookCallback(object):
    """Implementation of the 'SubscriptionCompletedWebhookCallback' model.

    Webhook envelope for the subscription_completed event.

    Attributes:
        id (uuid|str): Unique ID of this webhook delivery.
        event (str): Event type discriminator — always `subscription_completed` for
            this callback.
    ...
    def __init__(
        ...
        """Initialize a SubscriptionCompletedWebhookCallback instance."""
        # Initialize members of the class
        self.id = id
        self.event = "subscription_completed"
