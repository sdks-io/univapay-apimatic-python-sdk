...
class TokenThreeDsUpdatedWebhookCallback(object):
    """Implementation of the 'TokenThreeDsUpdatedWebhookCallback' model.

    Webhook envelope for the token_three_d_s_updated event.

    Attributes:
        id (uuid|str): Unique ID of this webhook delivery.
        event (str): Event type discriminator — always `token_three_d_s_updated` for
            this callback.
    ...
    def __init__(
        ...
        """Initialize a TokenThreeDsUpdatedWebhookCallback instance."""
        # Initialize members of the class
        self.id = id
        self.event = "token_three_d_s_updated"
