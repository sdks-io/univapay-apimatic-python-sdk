...
class TokenUpdatedWebhookCallback(object):
    """Implementation of the 'TokenUpdatedWebhookCallback' model.

    Webhook envelope for the token_updated event.

    Attributes:
        id (uuid|str): Unique ID of this webhook delivery.
        event (str): Event type discriminator — always `token_updated` for this
            callback.
    ...
    def __init__(
        ...
        """Initialize a TokenUpdatedWebhookCallback instance."""
        # Initialize members of the class
        self.id = id
        self.event = "token_updated"
