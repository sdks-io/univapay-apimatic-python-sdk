...
class TokenReplacedWebhookCallback(object):
    """Implementation of the 'TokenReplacedWebhookCallback' model.

    Webhook envelope for the token_replaced event.

    Attributes:
        id (uuid|str): Unique ID of this webhook delivery.
        event (str): Event type discriminator — always `token_replaced` for this
            callback.
    ...
    def __init__(
        ...
        """Initialize a TokenReplacedWebhookCallback instance."""
        # Initialize members of the class
        self.id = id
        self.event = "token_replaced"
