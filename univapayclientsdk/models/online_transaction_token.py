...
class OnlineTransactionToken(object):
    """Implementation of the 'OnlineTransactionToken' model.
    ...
    Attributes:
        ...
        payment_type (str): Payment method type. Always `online` for this variant.
        data (TokenResponseOnlineData): Token Response Online Data schema.
    ...
    def __init__(
        ...
        """Initialize a OnlineTransactionToken instance."""
    ...
    def from_dictionary(cls,
        ...
        data =\
            TokenResponseOnlineData.from_dictionary(
                dictionary.get("data"))\
        ...
        if isinstance(dictionary, cls):
            return APIHelper.is_valid_type(
                ...
                and APIHelper.is_valid_type(
                    ...
                    type_callable=lambda value:
                        TokenResponseOnlineData.validate(value),
                    is_model_dict=True)
