...
class MerchantWebhookQrScanConfiguration(object):
    """Implementation of the 'MerchantWebhookQRScanConfiguration' model.

    QR scan payment settings.

    Attributes:
        enabled (bool): Enables QR scan payments.
    ...
    def __init__(
        ...
        """Initialize a MerchantWebhookQrScanConfiguration instance."""
