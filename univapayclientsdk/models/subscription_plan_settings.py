...
class SubscriptionPlanSettings(object):
    """Implementation of the 'SubscriptionPlanSettings' model.

    Configuration for limited-cycle subscriptions (Univapay side).

    Attributes:
        plan_type (PlanSettingsType): Plan type selector.
        fixed_cycles (int): Number of cycles for fixed_cycles plan.
        fixed_cycle_amount (int): Total target amount for fixed_cycle_amount plan.
    ...
    def __init__(
        ...
        """Initialize a SubscriptionPlanSettings instance."""
