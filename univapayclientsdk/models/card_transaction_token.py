...
class CardTransactionToken(object):
    """Implementation of the 'CardTransactionToken' model.
    ...
    Attributes:
        ...
        payment_type (str): Payment method type. Always `card` for this variant.
        data (TokenResponseCardData): Token Response Card Data schema.
    ...
    def __init__(
        ...
        """Initialize a CardTransactionToken instance."""
    ...
    def from_dictionary(cls,
        ...
        data =\
            TokenResponseCardData.from_dictionary(
                dictionary.get("data"))\
        ...
        if isinstance(dictionary, cls):
            return APIHelper.is_valid_type(
                ...
                and APIHelper.is_valid_type(
                    ...
                    type_callable=lambda value:
                        TokenResponseCardData.validate(value),
                    is_model_dict=True)
