...
class ChargeUpdatedWebhookCallback(object):
    """Implementation of the 'ChargeUpdatedWebhookCallback' model.

    Webhook envelope for the charge_updated event.

    Attributes:
        id (uuid|str): Unique ID of this webhook delivery.
        event (str): Event type discriminator — always `charge_updated` for this
            callback.
    ...
    def __init__(
        ...
        """Initialize a ChargeUpdatedWebhookCallback instance."""
        # Initialize members of the class
        self.id = id
        self.event = "charge_updated"
