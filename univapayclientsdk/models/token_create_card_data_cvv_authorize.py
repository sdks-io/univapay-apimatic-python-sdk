...
class TokenCreateCardDataCvvAuthorize(object):
    """Implementation of the 'TokenCreateCardDataCvvAuthorize' model.
    ...
    def __init__(
        ...
        """Initialize a TokenCreateCardDataCvvAuthorize instance."""
