...
class SubscriptionPayment(object):
    """Implementation of the 'SubscriptionPayment' model.
    ...
    Attributes:
        ...
        is_paid (bool): Indicates whether this specific payment cycle has been
            successfully charged.
        is_last_payment (bool): Indicates if this is the final payment in a
            limited-cycle subscription.
    ...
    def __init__(
        ...
        """Initialize a SubscriptionPayment instance."""
