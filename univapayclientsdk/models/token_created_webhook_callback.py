...
class TokenCreatedWebhookCallback(object):
    """Implementation of the 'TokenCreatedWebhookCallback' model.

    Webhook envelope for the token_created event.

    Attributes:
        id (uuid|str): Unique ID of this webhook delivery.
        event (str): Event type discriminator — always `token_created` for this
            callback.
    ...
    def __init__(
        ...
        """Initialize a TokenCreatedWebhookCallback instance."""
        # Initialize members of the class
        self.id = id
        self.event = "token_created"
