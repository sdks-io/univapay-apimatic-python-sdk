...
class TokenCvvAuthCheckUpdatedWebhookCallback(object):
    """Implementation of the 'TokenCvvAuthCheckUpdatedWebhookCallback' model.

    Webhook envelope for the token_cvv_auth_check_updated event.

    Attributes:
        id (uuid|str): Unique ID of this webhook delivery.
        event (str): Event type discriminator — always `token_cvv_auth_check_updated`
            for this callback.
    ...
    def __init__(
        ...
        """Initialize a TokenCvvAuthCheckUpdatedWebhookCallback instance."""
        # Initialize members of the class
        self.id = id
        self.event = "token_cvv_auth_check_updated"
