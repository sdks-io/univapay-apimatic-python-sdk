...
class TokenResponseCardDataThreeDsStatus(object):
    """Implementation of the 'TokenResponseCardDataThreeDsStatus' enum.
    ...
    _all_values = ["pending", "awaiting", "successful", "failed", "error"]
    PENDING = "pending"
