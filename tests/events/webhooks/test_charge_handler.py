...
class TestChargeHandler(unittest.TestCase):
    """
     Unit tests for the `ChargeHandler` event group handler.
    """
    ...
    def _make_request(body_obj) -> Request:
        ...
        """
        raw = TestChargeHandler._json_bytes(body_obj)
        return Request(
            method="POST",
            path="/webhooks",
    ...
    def test_charge_updated_from_charge_handler(self):
        """
    ...
    def test_charge_finished_from_charge_handler(self):
        """
    ...
    def test_unknown_event(self):
        """
         Tests the `UnknownEvent` case from ChargeHandler.
        """
        # arrange
        event_payload = ""
        core_req = self._make_request(event_payload)
