...
class TestSubscriptionCanceledHandler(unittest.TestCase):
    """
     Unit tests for the `SubscriptionCanceledHandler` event group handler.
    """
    ...
    def _make_request(body_obj) -> Request:
        ...
        """
        raw = TestSubscriptionCanceledHandler._json_bytes(body_obj)
        return Request(
            method="POST",
            path="/webhooks",
    ...
    def test_subscription_canceled_from_subscription_canceled_handler(self):
        """
         Tests the `subscriptionCanceled` event from subscriptionCanceledHandler.
        """
        # arrange
        event_payload = {
    ...
    def test_unknown_event(self):
        """
         Tests the `UnknownEvent` case from SubscriptionCanceledHandler.
        """
        # arrange
        event_payload = ""
        core_req = self._make_request(event_payload)
