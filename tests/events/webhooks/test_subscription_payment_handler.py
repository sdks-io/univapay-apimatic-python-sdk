...
class TestSubscriptionPaymentHandler(unittest.TestCase):
    """
     Unit tests for the `SubscriptionPaymentHandler` event group handler.
    """
    ...
    def _make_request(body_obj) -> Request:
        ...
        """
        raw = TestSubscriptionPaymentHandler._json_bytes(body_obj)
        return Request(
            method="POST",
            path="/webhooks",
    ...
    def test_subscription_payment_from_subscription_payment_handler(self):
        """
         Tests the `subscriptionPayment` event from subscriptionPaymentHandler.
        """
        # arrange
        event_payload = {
    ...
    def test_unknown_event(self):
        """
         Tests the `UnknownEvent` case from SubscriptionPaymentHandler.
        """
        # arrange
        event_payload = ""
        core_req = self._make_request(event_payload)
