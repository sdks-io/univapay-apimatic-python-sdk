...
class TestChargeUpdatedHandler(unittest.TestCase):
    """
     Unit tests for the `ChargeUpdatedHandler` event group handler.
    """
    ...
    def _make_request(body_obj) -> Request:
        ...
        """
        raw = TestChargeUpdatedHandler._json_bytes(body_obj)
        return Request(
            method="POST",
            path="/webhooks",
    ...
    def test_charge_updated_from_charge_updated_handler(self):
        """
         Tests the `chargeUpdated` event from chargeUpdatedHandler.
        """
        # arrange
        event_payload = {
    ...
    def test_unknown_event(self):
        """
         Tests the `UnknownEvent` case from ChargeUpdatedHandler.
        """
        # arrange
        event_payload = ""
        core_req = self._make_request(event_payload)
