...
class TestSubscriptionFailureHandler(unittest.TestCase):
    """
     Unit tests for the `SubscriptionFailureHandler` event group handler.
    """
    ...
    def _make_request(body_obj) -> Request:
        ...
        """
        raw = TestSubscriptionFailureHandler._json_bytes(body_obj)
        return Request(
            method="POST",
            path="/webhooks",
    ...
    def test_subscription_failure_from_subscription_failure_handler(self):
        """
         Tests the `subscriptionFailure` event from subscriptionFailureHandler.
        """
        # arrange
        event_payload = {
    ...
    def test_unknown_event(self):
        """
         Tests the `UnknownEvent` case from SubscriptionFailureHandler.
        """
        # arrange
        event_payload = ""
        core_req = self._make_request(event_payload)
