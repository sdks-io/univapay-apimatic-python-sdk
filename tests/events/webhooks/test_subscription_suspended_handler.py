...
class TestSubscriptionSuspendedHandler(unittest.TestCase):
    """
     Unit tests for the `SubscriptionSuspendedHandler` event group handler.
    """
    ...
    def _make_request(body_obj) -> Request:
        ...
        """
        raw = TestSubscriptionSuspendedHandler._json_bytes(body_obj)
        return Request(
            method="POST",
            path="/webhooks",
    ...
    def test_subscription_suspended_from_subscription_suspended_handler(self):
        """
         Tests the `subscriptionSuspended` event from subscriptionSuspendedHandler.
        """
        # arrange
        event_payload = {
    ...
    def test_unknown_event(self):
        """
         Tests the `UnknownEvent` case from SubscriptionSuspendedHandler.
        """
        # arrange
        event_payload = ""
        core_req = self._make_request(event_payload)
