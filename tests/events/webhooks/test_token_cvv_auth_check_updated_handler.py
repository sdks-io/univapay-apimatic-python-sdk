...
class TestTokenCvvAuthCheckUpdatedHandler(unittest.TestCase):
    """
     Unit tests for the `TokenCvvAuthCheckUpdatedHandler` event group handler.
    """
    ...
    def _make_request(body_obj) -> Request:
        ...
        """
        raw = TestTokenCvvAuthCheckUpdatedHandler._json_bytes(body_obj)
        return Request(
            method="POST",
            path="/webhooks",
    ...
    def test_token_cvv_auth_check_updated_from_token_cvv_auth_check_updated_handler(
        self,
    ):
        """
         Tests the `tokenCvvAuthCheckUpdated` event from
        tokenCvvAuthCheckUpdatedHandler.
        """
        # arrange
        event_payload = {
    ...
    def test_unknown_event(self):
        """
         Tests the `UnknownEvent` case from TokenCvvAuthCheckUpdatedHandler.
        """
        # arrange
        event_payload = ""
        core_req = self._make_request(event_payload)
