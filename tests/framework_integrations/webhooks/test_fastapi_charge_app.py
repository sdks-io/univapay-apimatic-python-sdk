...
from tests.framework_integrations.webhooks.apps.fastapi_charge_app import (
    app,
)


class FastapiChargeTest(unittest.TestCase):
    """
     Integration tests for `charge` using a FastAPI application.
    """
    ...
    def test_charge_updated_from_charge_app(self):
        """
