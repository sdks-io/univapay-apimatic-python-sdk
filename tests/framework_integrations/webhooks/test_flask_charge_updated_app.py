...
from tests.framework_integrations.webhooks.apps.flask_charge_updated_app import (
    create_app,
)


class FlaskChargeUpdatedTest(unittest.TestCase):
    """
     Integration tests for `chargeUpdated` using a Flask application.
    """
